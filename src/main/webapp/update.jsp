		...
		<div class="content">
			<div class="vote-content">
					...
					<dl>
						...
						<dt>投票类型：</dt>
						<dd>
				  		   <input type="radio" name="subject.type" value="1" <s:if test="subject.type==1">checked=checked</s:if>/>单选
						   <input type="radio" name="subject.type" value="2" <s:if test="subject.type==2">checked=checked</s:if>/>多选
						</dd>
						<dt>投票选项：</dt>
						<dd id="voteoptions">
