	...
	<div class="content">
	   <form method="post" action="Register!register.action">
			<dl>
				...
				<dt>用户名：</dt>
				<dd><input type="text" class="input-text" name="userName" value="<s:property value='userName'/>"/></dd>
				<dt>密码：</dt>
				<dd><input type="password" class="input-text" name="password" value="<s:property value='password'/>"/></dd>
				<dt>确认密码：</dt>
				<dd><input type="password" class="input-text" name="confirmPassword" value="<s:property value='confirmPassword'/>"/></dd>
				<dt></dt>
